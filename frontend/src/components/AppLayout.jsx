...
const NAV_BY_ROLE = {
  caseworker: [
    ...
    { to: "/caseworker/cases", label: "Case Management", icon: Briefcase },
    ...
    { to: "/caseworker/integrations", label: "Integrations", icon: Zap },
    { to: "/survival-bible", label: "Survival Bible", icon: Book },
  ...
  resident: [
    ...
    { to: "/resident/documents", label: "Document Locker", icon: FileText },
    { to: "/resident/tasks", label: "Tasks", icon: ListChecks },
    { to: "/resident/messages", label: "Messages", icon: MessageSquare },
    { to: "/resident/applications", label: "Applications", icon: Briefcase },
    { to: "/survival-bible", label: "Survival Bible", icon: Book },
  ...
  admin: [
    ...
    { to: "/architect", label: "Architect Dashboard", icon: Shield },
