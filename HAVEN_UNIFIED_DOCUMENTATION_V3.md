...
**Status**: Current — reflects major repo reorganization and feature integration  
**Last Updated**: 2025  
...
**HAVEN** is an enterprise-grade civic technology platform designed to help housing-insecure and underserved residents navigate government benefits and housing assistance. It bridges residents with government agencies and nonprofits through a dignified, intuitive user experience.

### Mission
- **Residents**: One unified dashboard for documents, applications, case tracking, and crisis support
- **Caseworkers**: Full case management, agency integrations, BB automation, and workload visibility
- **Agencies**: Seamless intake, real-time tracking, and inter-agency coordination
- **Administrators**: System oversight, OAuth setup, audit logging, and analytics

### Core Value Propositions
- **Dignity-First Design**: Clean, uncluttered UX — no bureaucratic language
- **Zero Barriers**: Works offline, supports voice chat, accessible via any device
- **AI-Powered**: BB assists residents AND caseworkers; no LLM credits necessary (local Ollama default)
- **Interoperable**: Connects to 12 major government agencies (HUD, SSA, USDA, CMS, VA, IRS, DOL, DMV, HHS, WIC, CPS, Court eFiling)
- **Privacy-Forward**: End-to-end encryption vault, zero-knowledge architecture where possible, HIPAA-aligned
